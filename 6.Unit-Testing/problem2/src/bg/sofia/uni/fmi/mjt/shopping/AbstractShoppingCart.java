...
public abstract class AbstractShoppingCart implements ShoppingCart {
    ...
    protected static final String ITEM_NULL_MSG = "Item cannot be null";
    protected static final String ITEM_NOT_FOUND_MSG = "Item with id {0} not found";
    ...
    static void validateItemNotNull(Item item) {
        if (item == null) {
            throw new IllegalArgumentException(ITEM_NULL_MSG);
        }
    }
}
